...
const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      {
        text: "All-day champion",
        value: 0,
        icon: Smile,
        color: "text-brand-600",
      },
      {
        text: "Needs frequent charging",
        value: 2,
        icon: Meh,
...
export function TechHealthCheck() {
  ...
  const getRecommendations = () => {
    const recs = [];
    const performanceAnswer = answers.find(
      (a) => a.questionId === "performance"
    );
                          ...
                          >
                            ...
                            >
                              <div className="flex items-center space-x-4 w-full">
                                <div
                                  className={`p-3 rounded-xl bg-slate-100 group-hover:bg-white transition-colors`}
                                >
                                  {(() => {
                ...
                <Card className="border-0 shadow-2xl bg-gradient-to-br from-brand-50 to-accent-50 rounded-3xl">
                  <CardContent className="p-8">
                    <h3 className="text-2xl font-bold text-slate-800 mb-4">
                      Ready to give your device some love?
                    </h3>
                    <p className="text-lg text-slate-600 mb-8">
                      Our expert technicians are here to help keep your
                      technology running smoothly. Get a personalized service
                      plan today!
                    </p>
